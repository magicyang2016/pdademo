...
import com.magic.pdademo.inter.PrinterCallback;
    ...
    public void printTable(LinkedList<TableItem> list, ICallback iCallback) {
        ...
        try {
            for (TableItem tableItem : list) {
                Log.i("kaltin", "printTable: "+tableItem.getText()[0]+tableItem.getText()[1]);
                Log.i("kaltin", "printTable: "+tableItem.getAlign()[0]+tableItem.getAlign()[1]);
                Log.i("kaltin", "printTable: "+tableItem.getWidth()[0]+tableItem.getWidth()[1]);
                woyouService.printColumnsString(tableItem.getText(), tableItem.getWidth(), tableItem.getAlign(), null);
            }
//            woyouService.printColumnsText(new String[]{"条码","名称","数量"}, new int[]{12,12,8}, new int[]{0,1,2},null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
